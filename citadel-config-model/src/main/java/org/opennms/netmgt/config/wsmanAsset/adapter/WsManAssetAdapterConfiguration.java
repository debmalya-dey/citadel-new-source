...
@XmlRootElement(name = "wsman-asset-adapter-configuration")
@XmlAccessorType(XmlAccessType.FIELD)
@ValidateUsing("wsman-asset-adapter-configuration.xsd")
public class WsManAssetAdapterConfiguration implements Serializable {
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof WsManAssetAdapterConfiguration) {
            final WsManAssetAdapterConfiguration that = (WsManAssetAdapterConfiguration)obj;
