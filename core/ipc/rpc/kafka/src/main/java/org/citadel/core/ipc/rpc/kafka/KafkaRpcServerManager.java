 ...
 * License.
 */
package org.citadel.core.ipc.rpc.kafka;

import static org.citadel.core.ipc.common.kafka.KafkaRpcConstants.MAX_CONCURRENT_CALLS_PROPERTY;
import static org.citadel.core.ipc.common.kafka.KafkaRpcConstants.MAX_DURATION_BULK_HEAD;
import static org.citadel.core.ipc.common.kafka.KafkaRpcConstants.SINGLE_TOPIC_FOR_ALL_MODULES;
import static org.citadel.core.rpc.api.RpcClientFactory.RPC_FAILED;
import static org.citadel.core.rpc.api.RpcClientFactory.RPC_REQUESTS_RECEIVED;
...
import org.citadel.core.ipc.common.kafka.KafkaConfigProvider;
import org.citadel.core.ipc.common.kafka.KafkaRpcConstants;
import org.citadel.core.ipc.common.kafka.KafkaTopicProvider;
import org.citadel.core.ipc.common.kafka.Utils;
import org.citadel.core.ipc.rpc.kafka.model.RpcMessageProto;
...
public class KafkaRpcServerManager {
    ...
    final static String ACTIVE_RPC_REQUESTS = "activeRpcRequests";
    final static String AVAILABLE_CONCURRENT_CALLS = "availableConcurrentCalls";
    private final static String MAX_ALLOWED_CONCURRENT_CALLS = "maxAllowedConcurrentCalls";
    ...
    class KafkaConsumerRunner implements Runnable {
        ...
        private void checkBulkHead() {
            if (!bulkhead.tryAcquirePermission()) {
                extraThreadsBeyondThreshold.incrementAndGet();
            }
            activeThreads.incrementAndGet();
        }


        private void uncheckBulkhead() {
            if (extraThreadsBeyondThreshold.get() > 0) {
                extraThreadsBeyondThreshold.decrementAndGet();
            } else {
                bulkhead.onComplete();
            }
