 ...
 * License.
 */
package org.citadel.core.ipc.twin.grpc.common;

import org.citadel.core.ipc.twin.model.TwinRequestProto;
import org.citadel.core.ipc.twin.model.TwinResponseProto;
...
public final class OpenNMSTwinIpcGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<TwinRequestProto,
          TwinResponseProto> getRpcStreamingMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "RpcStreaming",
      requestType = TwinRequestProto.class,
      responseType = TwinResponseProto.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<TwinRequestProto,
          TwinResponseProto> getRpcStreamingMethod() {
    io.grpc.MethodDescriptor<TwinRequestProto, TwinResponseProto> getRpcStreamingMethod;
      ...
      synchronized (OpenNMSTwinIpcGrpc.class) {
        if ((getRpcStreamingMethod = OpenNMSTwinIpcGrpc.getRpcStreamingMethod) == null) {
          OpenNMSTwinIpcGrpc.getRpcStreamingMethod = getRpcStreamingMethod =
              io.grpc.MethodDescriptor.<TwinRequestProto, TwinResponseProto>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RpcStreaming"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  TwinRequestProto.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  TwinResponseProto.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<MinionHeader,
          TwinResponseProto> getSinkStreamingMethod;
  ...
  public static io.grpc.MethodDescriptor<MinionHeader,
          TwinResponseProto> getSinkStreamingMethod() {
    io.grpc.MethodDescriptor<MinionHeader, TwinResponseProto> getSinkStreamingMethod;
      ...
      synchronized (OpenNMSTwinIpcGrpc.class) {
        if ((getSinkStreamingMethod = OpenNMSTwinIpcGrpc.getSinkStreamingMethod) == null) {
          OpenNMSTwinIpcGrpc.getSinkStreamingMethod = getSinkStreamingMethod =
              io.grpc.MethodDescriptor.<MinionHeader, TwinResponseProto>newBuilder()
  ...
  public static abstract class OpenNMSTwinIpcImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public io.grpc.stub.StreamObserver<TwinRequestProto> rpcStreaming(
        io.grpc.stub.StreamObserver<TwinResponseProto> responseObserver) {
  ...
  public static final class OpenNMSTwinIpcBlockingStub extends io.grpc.stub.AbstractBlockingStub<OpenNMSTwinIpcBlockingStub> {
     ...
     * </pre>
     */
    public java.util.Iterator<TwinResponseProto> sinkStreaming(
