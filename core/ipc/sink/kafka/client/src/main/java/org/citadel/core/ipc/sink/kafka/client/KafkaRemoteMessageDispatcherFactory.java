 ...
 * License.
 */
package org.citadel.core.ipc.sink.kafka.client;

import static org.citadel.core.ipc.common.kafka.KafkaSinkConstants.DEFAULT_MAX_BUFFER_SIZE;
import static org.citadel.core.ipc.common.kafka.KafkaSinkConstants.KAFKA_COMMON_CONFIG_PID;
import static org.citadel.core.ipc.common.kafka.KafkaSinkConstants.MAX_BUFFER_SIZE_PROPERTY;
...
import org.citadel.core.camel.JmsQueueNameFactory;
import org.citadel.core.ipc.common.kafka.KafkaConfigProvider;
import org.citadel.core.ipc.common.kafka.KafkaSinkConstants;
import org.citadel.core.ipc.common.kafka.OsgiKafkaConfigProvider;
...
import org.citadel.core.ipc.sink.model.SinkMessage;
