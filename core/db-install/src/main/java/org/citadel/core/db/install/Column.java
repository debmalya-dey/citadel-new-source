 ...
 * License.
 */
package org.citadel.core.db.install;
...
public class Column {
    ...
    public int columnTypeSize(String type) throws Exception {
        if (type.equals("boolean") || type.equals("character")) {
            ...
            return 8;
        } else if (type.equals("double precision") || type.equals("real") || type.equals("text") || type.equals("bytea") || type.equals("trigger") || type.equals("jsonb")) {
            return -1;
        } else {
