 ...
 * License.
 */
package org.citadel.core.soa.support;

import java.util.List;
import java.util.concurrent.CopyOnWriteArrayList;

import org.citadel.core.soa.Filter;
import org.citadel.core.soa.Registration;
import org.citadel.core.soa.RegistrationListener;
import org.citadel.core.soa.ServiceRegistry;
import org.citadel.core.soa.filter.FilterParser;
...
public class ReferenceListFactoryBean<T> implements FactoryBean<List<T>>, InitializingBean, RegistrationListener<T> {
     ...
     *
     * @param serviceRegistry a {@link ServiceRegistry} object.
     */
     ...
     * <p>setListener</p>
     *
     * @param listener a {@link RegistrationListener} object.
     */
