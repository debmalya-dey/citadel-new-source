...
public class HikariCPConnectionFactory extends BaseConnectionFactory {
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#initializePool(org.opennms.netmgt.config.opennmsDataSources.JdbcDataSource)
     */
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#getUrl()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#setUrl(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#getUser()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#setUser(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#getDataSource()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.ClosableDataSource#setLoginTimeout(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#getLoginTimeout()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.BaseConnectionFactory#close()
     */
    @Override
    public void close() {
        super.close();
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.ClosableDataSource#setIdleTimeout(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.ClosableDataSource#setMinPool(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.ClosableDataSource#setMaxPool(int)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see db.org.citadel.core.ClosableDataSource#setMaxSize(int)
     */
    @Override
