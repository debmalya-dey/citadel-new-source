 ...
 * License.
 */
package org.citadel.core.utils.url;
...
public class GenericURLFactoryTest {
    ...
    public void testCreateURLStreamHandler() {
        m_genericURLFactory.addURLConnection("testprotocol", "url.utils.org.citadel.core.StubGenericURLConnection");
        m_genericURLFactory.addURLConnection("noclass", "org.opennms.bkd.class.not.found");
        Assert.assertEquals("Test get test protocol class", m_genericURLFactory.createURLStreamHandler("testprotocol").getClass().getName(), "url.utils.org.citadel.core.GenericURLStreamHandler");
